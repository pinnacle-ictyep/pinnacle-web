    ...
    <div class="container">
      ...
      <div class="row">
        <div class="explore" id="hotels">
          <h3>Available hotels Near you </h3>
          <p>A selection of the best hotel available today</p>
        </div>
      </div>
      ...
      {{-- <div class="row">
        <div class="downloadapp">
          <button type="button" class="btnsign btn-primary btn btn-lg me-2">To see more</button>
        </div>
      </div>
       --}}
